...
The first electronic storage of data was done in file systems. Previously we saw some of the problems that eventually developed. Due to growth in the amount of data stored and the increase in number of people needing access to that data, specialized software systems were developed to address data storage. This specialized software was called a database management system (DBMS).
Historically, DBMSs have been categorized based on the data storage model used. There are five primary models:
...
Upside down tree hierarchical tree view.

Figure 1

We can model student data using a hierarchical structure. Assume a student takes courses. Each student can take one or more courses. A hierarchical model for this data is presented below.

Hierarchical model for student taking classes.

Figure 2

The best known hierarchical database was created by IBM in the mid 1960s for the Apollo moon missions. It was named Information Management System or IMS. This database is still available today.
